const Nav = () => {
  return (
    <>
      <header className="bg-white top-0 sticky z-50 shadow">
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-8 px-4 sm:px-6 lg:px-8">
          <a className="block text-teal-600" href="#Note">
            ...
            <nav aria-label="Global" className="hidden md:block">
              <ul className="flex items-center gap-6 text-sm">
                ...
                <li>
                  <a
                    className="text-gray-500 transition hover:text-gray-500/75"
                    href="https://www.anthonysjhenry.dev"
                    target="_blank"
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert("Login is currently working under Todos.");
                  }}
                >
                  Login
                </a>
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert("Registration is currently working under Todos.");
                  }}
                >
                  Sign Up
                </a>
